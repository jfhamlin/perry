...
public:
    ...
    void SetScene(SolsticeScene* scene);
    const SolsticeScene* Scene() const { return m_scene; }
    const romulus::render::Camera& Camera() const { return m_camera.Camera(); }
